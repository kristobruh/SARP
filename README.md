...
```
cd existing_repo
git remote add origin https://gitlab.com/fgi_nls/kauko/chade/sarp.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/fgi_nls/kauko/chade/sarp/-/settings/integrations)
